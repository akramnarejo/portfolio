        ...
        {skills.map((item, ind) => {
          return (
            <motion.span
              ...
              viewport={{once: true}}
              key={ind}
              className={`md:text-xl dark:bg-black border dark:border-[#444] border-[#999] dark:hover:border-blue-200 dark:hover:text-blue-200 hover:border-blue-400 hover:text-blue-600 p-2 rounded-lg text-[#666] hover:skew-y-3 ease-in-out duration-500 hover:scale-110`}
            >
              {item}
            </motion.span>
          );
